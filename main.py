...
# bot
bot_token = os.environ.get("TOKEN", "5916194884:AAGnPe1OZ7FUNqZ4fBIx4Ifb6vSPFiTYiU0")
api_hash = os.environ.get("HASH", "ce109d0baed40d7da8a762be8737da4f") 
api_id = os.environ.get("ID", "12278858")
